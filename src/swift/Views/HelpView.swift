...
private let helpData: [HelpSection] = [
    HelpSection(title: "File Placement", icon: "folder", items: [
        ...
        HelpItem(
            ...
            answer: "On Mac: open Finder, select your iPhone in the sidebar, then the Files tab. On Windows: use iTunes > File Sharing. You can also use the iOS Files app (On My iPhone > Cobalis)."
        ),
    ]),
