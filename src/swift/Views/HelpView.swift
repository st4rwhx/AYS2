...
private let helpData: [HelpSection] = [
    HelpSection(title: "Settings Guide", icon: "gearshape", items: [
        ...
        HelpItem(
            ...
            answer: "Enable GameDB patches for built-in compatibility fixes. PNACH cheats can be imported from the in-game quick menu; AYS2 renames them to the current game's Serial_CRC.pnach and keeps // comments compatible with the core parser."
        ),
        HelpItem(
